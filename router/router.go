...
import (
	"hrgdrc/handler/api/record"
	"hrgdrc/handler/api/statistics"
	"hrgdrc/pkg/auth"
	"net/http"
	...
	_ "hrgdrc/docs" // docs is generated by Swag CLI, you have to import it.
	"hrgdrc/handler/api/audit"
	"hrgdrc/handler/api/group"
	transfer "hrgdrc/handler/api/grouptransfer"
	"hrgdrc/handler/api/permission"
	"hrgdrc/handler/api/profile"
	"hrgdrc/handler/api/role"
	"hrgdrc/handler/api/salary"
	"hrgdrc/handler/api/sd"
	"hrgdrc/handler/api/tag"
	"hrgdrc/handler/api/templateaccount"
	"hrgdrc/handler/api/tool"
	"hrgdrc/handler/api/user"
	"hrgdrc/handler/api/usergroup"
